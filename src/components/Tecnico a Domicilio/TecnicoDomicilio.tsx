  ...
  return (
    <IonContent className="tecnico-domicilio-container">
      ...
      <div className="tecnico-domicilio-top-box">
        <h3>
          <strong>Orden Activa</strong> #25645
        </h3>
        <h3>Martin Inchausti</h3>
        <h3>
          <svg
            width="14"
            height="20"
        ...
        <div>
          <IonButton
            ...
            onClick={() => handleButtonClick("/verorden")}
          >
            Ver orden
          </IonButton>
      ...
      <div className="tecnico-domicilio-bottom-box">
        <h4>
          Orden #2500 <span>Visita pendiente</span>
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <h4>
          Orden #2502 <span>Para retirar</span>
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
