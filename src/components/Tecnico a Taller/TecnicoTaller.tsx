  ...
  return (
    <IonContent className="tecnico-taller-container">
      ...
      <div className="tecnico-taller-top-box">
        ...
        <h3>#25645</h3>
        <h3>
          <strong>Producto:</strong>Lavavajillas
        </h3>
        <h3>
          <strong>Marca:</strong>Candy
        </h3>
        <h3>
          <strong>Modelo:</strong>Evospace 123
        </h3>
        <h3>
          <strong>No. de cliente:</strong>1245
        </h3>
      ...
      <div className="tecnico-taller-bottom-box">
        <h4>
          Orden #2500 <span>Orden en curso</span>{" "}
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <h4>
          Orden #2501 <span>En taller</span>{" "}
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
        ...
        <h4>
          Orden #2502 <span>Finalizada</span>
          <svg
            width="18"
            height="18"
            viewBox="0 0 18 18"
