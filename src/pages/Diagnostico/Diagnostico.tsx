...
const Diagnostico: React.FC = () => {
  ...
  const { cargarOrdenes, ordenActiva, setOrdenActiva, tiposDeFunciones } =
    useOrden();
        ...
        <div className="diagnostico-ctn">
          <div className="section">
            ...
            <div className="item2">
              ...
              <IonInput
                className={inputErrors.marca ? "input-error" : ""}
                style={{ marginLeft: "10px" }}
                value={marca}
          ...
          <div className="section">
            ...
            <div
              className={`checkbox-container ${
                inputErrors.checkbox ? "checkbox-error" : ""
              }`}
            >
          ...
          <div className="bottom-buttons-diagnostico">
            <IonButton
              ...
              onClick={() => handleFotosClick(false)}
            >
              Agregar/Ver Fotos
            </IonButton>
            <IonButton
