  ...
  useEffect(() => {
    if (ordenActiva && ordenActiva.diagnostico) {
      const updatedCheckboxValues = textosCheckbox.map((texto) =>
        ordenActiva.diagnostico.includes(texto)
      );
      ...
      <IonContent>
        ...
        <div className="diagnostico-ctn">
          ...
          <div className="section">
            ...
            <div
              role="radiogroup"
              aria-labelledby="radioOptionsLabel"
