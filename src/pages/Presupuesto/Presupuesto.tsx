...
const Presupuesto: React.FC = () => {
  ...
  const handleConfirmAlert = async () => {
    ...
    handleSocket(dataToSend.id_orden);
  };
  const handleSocket = (id_orden: number) => {
    socket.emit('todasNotificaciones', { message: `Mensaje desde Confirmación de Orden con orden #${id_orden}` });
